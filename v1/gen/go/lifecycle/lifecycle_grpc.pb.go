...
const (
	LifeCycleService_Init_FullMethodName = "/opi_api.lifecycle.v1.LifeCycleService/Init"
)
...
var LifeCycleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "opi_api.lifecycle.v1.LifeCycleService",
	...
	Metadata: "lifecycle/lifecycle.proto",
}

const (
	DeviceService_GetDevices_FullMethodName = "/opi_api.lifecycle.v1.DeviceService/GetDevices"
	DeviceService_SetNumVfs_FullMethodName  = "/opi_api.lifecycle.v1.DeviceService/SetNumVfs"
)
...
type DeviceServiceClient interface {
	...
	SetNumVfs(ctx context.Context, in *SetNumVfsRequest, opts ...grpc.CallOption) (*VfCount, error)
}
...
func (c *deviceServiceClient) SetNumVfs(ctx context.Context, in *SetNumVfsRequest, opts ...grpc.CallOption) (*VfCount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VfCount)
...
type DeviceServiceServer interface {
	...
	// Configure number of virtual functions for a device
	SetNumVfs(context.Context, *SetNumVfsRequest) (*VfCount, error)
...
func (UnimplementedDeviceServiceServer) SetNumVfs(context.Context, *SetNumVfsRequest) (*VfCount, error) {
...
func _DeviceService_SetNumVfs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).SetNumVfs(ctx, req.(*SetNumVfsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeviceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "opi_api.lifecycle.v1.DeviceService",
...
const (
	HeartbeatService_Ping_FullMethodName = "/opi_api.lifecycle.v1.HeartbeatService/Ping"
)
...
var HeartbeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "opi_api.lifecycle.v1.HeartbeatService",
